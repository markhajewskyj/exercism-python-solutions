...
# v2: refined logic using inbuilt // and % arithmetic operators.
# v3: improved logic correcting task 6 to ensure a value is returned and to use variables for ease of reading / debugging.
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    exchange_money tells us how much budget remains in new currency.

    get_number_of_bills tells us how many bills (notes) we'd get in new currency.

    
    """
    exchange_net = exchange_money(budget, (exchange_rate * (1 + spread / 100)))
    return get_value_of_bills(get_number_of_bills(exchange_net,denomination),denomination)
